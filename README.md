...
已在 Ubuntu 24.04、Python 3.10、PyTorch 2.5.0、CUDA 12.4 测试通过。
...
# 如果 CUDA 版本不为 12.4 (运行 nvidia-smi 确认)，请根据 PyTorch 官网安装对应版本
...
镜像说明:
- **AutoDL**: <https://www.codewithgpu.com/i/lipku/livetalking/base> — [教程](https://livetalking-doc.readthedocs.io/zh-cn/latest/autodl/README.html)
- **UCloud**: <https://www.compshare.cn/images/4458094e-a43d-45fe-9b57-de79253befe4?referral_code=3XW3852OBmnD089hMMrtuU&ytag=GPU_GitHub_livetalking> — 支持开放任意端口，无需额外部署 SRS — [教程](https://livetalking-doc.readthedocs.io/zh-cn/latest/ucloud/ucloud.html)
